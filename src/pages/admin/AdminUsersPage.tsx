...
import { Card, Button, Badge, Avatar, Input, Select, Modal, Dropdown } from '@/components/ui';
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <Card className="mb-6 bg-blue-50 border-blue-200">
            <div className="flex items-center justify-between">
              <p className="text-sm font-medium text-blue-900">
                {selectedUsers.size} {language === 'id' ? 'pengguna dipilih' : 'users selected'}
              </p>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-y border-gray-200">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">
                    {language === 'id' ? 'Login Terakhir' : 'Last Login'}
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">
        ...
        >
          <div className="space-y-4">
            ...
            />
            <Input
              label={language === 'id' ? 'Password Baru (kosongkan jika tidak ingin mengubah)' : 'New Password (leave blank to keep current)'}
              type="password"
              value={formData.password}
              onChange={(e) => setFormData({ ...formData, password: e.target.value })}
              placeholder="••••••••"
